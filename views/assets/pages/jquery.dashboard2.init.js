...
// LINE CHART
    var line=new Morris.Line( {
        ...
        ], xkey: 'y', ykeys: [ 'SeriesA', 'SeriesB'], labels: [ 'Series A','Series B'], gridLineColor: '#242946', lineColors: [ '#44a2d2', '#0acf97'], lineWidth: 2, hideHover: 'auto'
    });
